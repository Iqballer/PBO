...
public class LaptopCrud {
    ...
    public static void editLaptop() {
        ...
        System.out.print("Nama Baru (" + laptop.nama + "): ");
        laptop.nama = input.nextLine();
        System.out.print("Warna Baru (" + laptop.warna + "): ");
        laptop.warna = input.nextLine();
        System.out.print("Spek Baru (" + laptop.spek + "): ");
        laptop.spek = input.nextLine();
        System.out.print("Harga Baru (" + laptop.harga + "): ");
        laptop.harga = input.nextDouble();
        input.nextLine();

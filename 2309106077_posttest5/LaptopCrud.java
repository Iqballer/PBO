...
public class LaptopCrud {
    ...
    public static void tambahLaptop() {
        ...
        switch (jenis) {
            ...
            case 5:
                ...
                break;
            default:
                daftarLaptop.add(new StandardLaptop(nama, warna, spek, harga));
                break;
        }
    ...
    public static void tampilkanLaptop() {
        ...
        for (int i = 0; i < daftarLaptop.size(); i++) {
            ...
            daftarLaptop.get(i).tampilkanData(false);
        }
    }
    ...
    public static void editLaptop() {
        ...
        System.out.println("Nama: " + laptop.getNama()); // nama tidak dapat diubah
...
class StandardLaptop extends Laptop {
    public StandardLaptop(String nama, String warna, String spek, double harga) {
        super(nama, warna, spek, harga);
    }

    @Override
    public void deskripsi() {
        System.out.println("Tipe: Laptop Standar");
    }
}
